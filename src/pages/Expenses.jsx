  ...
  return (
    <div className="min-h-screen bg-white px-6 py-6 md:px-10 lg:px-14 text-gray-700">
      ...
      {/* ===============================
          TOTAL EXPENSES
      =============================== */}
      <div className="rounded-xl bg-[#FDE8E8] px-7 py-7 mb-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
        ...
        <div className="rounded-xl bg-gray-50 px-6 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              type="button"
              className="px-5 py-2.5 rounded-lg bg-green-50 border border-green-100 text-sm text-gray-600 flex items-center gap-2"
            >
              Add Category
