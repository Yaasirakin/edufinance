      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center px-8 py-12">
        ...
        <div className="w-full max-w-xl">
          ...
          <div className="flex items-start gap-3 mt-8">
            ...
            {/* Replace with your custom checkbox icon if needed */}
            <input
              type="checkbox"
              className="mt-1"
            />
          ...
          {/* Button */}
          <button className="w-full h-14 rounded-full bg-[#03C987] text-white font-semibold mt-8 hover:bg-[#02b57a] duration-300">
            Create Account
          </button>
          ...
          <p className="text-center text-gray-600 mt-8">
            I have an account?
            <span className="ml-2 font-semibold text-black cursor-pointer">
              Sign In
            </span>
          </p>
